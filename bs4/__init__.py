...
class BeautifulSoup(Tag):
    ...
    def __init__(self, markup="", features=None, builder=None,
        ...
        if hasattr(markup, 'read'):        # It's a file-type object.
            markup = markup.read()
        elif len(markup) <= 256 and (isinstance(markup, bytes) and b'<' not in markup or isinstance(markup, str) and '<' not in markup):
    ...
    def _decode_markup(cls, markup):
        ...
        anymore.
        """
        return markup.decode('utf-8', 'replace') if isinstance(markup, bytes) else markup
    ...
    def new_tag(self, name, namespace=None, nsprefix=None, attrs=None, sourceline=None, sourcepos=None, **kwattrs):
